...
NYC_idx = (1044, 2378)
NYC08_tseries = create_tseries(wtk, NYC_idx)[1]
...
def test_weibull_coeff():
    ...
    '''
    result_coeff = weibull_coeff(NYC08_tseries)
...
def test_weibull_pdf():
    ...
    result_pdf = weibull_pdf(test_windsp, test_k, test_c)
    ...
    for i in np.arange(0, 26, 1.0):
        val = weibull_pdf(i, 2.095213510638354, 6.873579224294875)
        tot_pdf.append(val)
...
def test_summation():
    ...
    '''
    result_summation = summation(NYC08_tseries)
...
def test_wind_energy_output():
    ...
    result_output = wind_energy_output(NYC08_tseries)
...
def test_create_tseries():
    ...
    '''
    result_tseries = create_tseries(wtk, NYC_idx)
...
def test_aeo_average():
    ...
    '''
    result_average = aeo_average(wtk, NYC_idx)
...
def test_wind_landuse():
    ...
    result_max_energy = wind_landuse(land_available, wtk, NYC_idx)
